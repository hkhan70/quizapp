...
function loadQuiz() {
  ...
  quizText.innerHTML = decodeURIComponent(currentQuizDate["question"]);
  a_text.innerHTML = decodeURIComponent(currentQuizDate["correct_answer"]);
  b_text.innerHTML = decodeURIComponent(
    currentQuizDate["incorrect_answers"][i]
  );
  c_text.innerHTML = decodeURIComponent(
    currentQuizDate["incorrect_answers"][i + 1]
  );
  d_text.innerHTML = decodeURIComponent(
    currentQuizDate["incorrect_answers"][i + 2]
  );

  document.getElementById("difficulty").innerHTML = decodeURIComponent(
    currentQuizDate["difficulty"]
  );
  document.getElementById("type").innerHTML = decodeURIComponent(
    currentQuizDate["type"]
  );
}
